...
vim.keymap.set("n", "<leader><leader>rn", "<cmd>set relativenumber!<CR>")
...
local function reload_config()
	...
	vim.notify("⚡️ init.lua reloaded", vim.log.levels.INFO, { title = "Neovim" })
end
vim.keymap.set("n", "<leader><leader>r", reload_config, { desc = "[R]eload Neovim config" })
...
-- Listener for plugins changes and build them
...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(event)
		...
		map("<leader>.", vim.lsp.buf.code_action, "[G]oto Code [A]ction", { "n", "x" })
